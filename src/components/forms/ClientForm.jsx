...
export default function ClientForm() {
  const inputStyle =
    "w-full border border-gray-300 rounded-lg p-2 text-gray-800 focus:outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100 transition duration-200";
  const labelStyle =
    "flex items-center gap-2 mb-2 font-medium text-emerald-600";
    ...
    <div className="min-h-screen bg-gray-100 md:p-6 p-2">
      ...
      <div className="max-w-6xl mx-auto bg-white p-8 rounded-2xl shadow-lg">
        ...
        >
          ...
          <div>
            <label className={labelStyle}>
              <FaCalendarAlt /> File Submission Date
            </label>
            <DatePicker
          ...
          <div>
            <label className={labelStyle}>
              <FaMoneyBillWave /> Total Service Charge
            </label>
            <input
              type="number"
              className={inputStyle}
          ...
          <div>
            <label className={labelStyle}>
              <FaMoneyBillWave /> Amount Received
            </label>
          ...
          <div>
            ...
            >
              ...
              <option value="Handed Over to Client">Handed Over to Client</option>
          ...
          <div className="md:col-span-2">
            <label className={labelStyle}>
              <FaFileAlt /> Initial Remarks
            </label>
            <textarea
              rows="3"
              className={inputStyle}
              placeholder="Enter initial notes about this client..."
              // If there is text in the first index of the array, show it
              value={formData.remarksHistory[0]?.text || ""}
              onChange={(e) => {
                const val = e.target.value;
                setFormData((prev) => ({
                  ...prev,
                  // Wrap the string into the array object format the DB now expects
                  remarksHistory: val ? [{ text: val, date: new Date() }] : [],
                }));
              }}
            />
          </div>
          ...
          <div className="md:col-span-2 mt-6">
            <button
              type="submit"
              disabled={loading}
              className="w-full md:w-1/2 mx-auto block bg-emerald-500 text-white font-bold py-3 rounded-xl shadow-lg hover:bg-emerald-600 transition-all disabled:opacity-50"
            >
