      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        <header className="relative bg-linear-to-br from-[#fdf2f8] to-[#fce4ec] rounded-[2.5rem] shadow-sm border border-pink-100 p-10 text-center overflow-hidden">
          ...
          <h1 className="text-4xl sm:text-6xl font-light tracking-tight text-slate-800 italic">
            Serbia <span className="font-extrabold not-italic bg-clip-text text-transparent bg-linear-to-r from-pink-500 to-slate-800">Work Visa</span>
          </h1>
          <p className="mt-4 text-slate-500 text-lg font-medium tracking-wide">Construction, Logistics & Maintenance</p>
        </header>
            ...
            <section className="bg-white border border-slate-200 rounded-3xl p-8 shadow-sm">
              <div className="flex items-center gap-3">
                 ...
                 <div>
                    ...
                    <p className="text-slate-800 font-medium text-sm">5-6 Months Total</p>
                 </div>
              </div>
            </section>
          </aside>
        ...
        <section className="bg-white rounded-[2.5rem] border border-slate-200 shadow-sm overflow-hidden">
          <div className="bg-slate-50/50 px-10 py-8 border-b border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="px-4 py-1.5 bg-white rounded-full border border-slate-200 text-[10px] font-bold text-slate-500 uppercase flex items-center gap-2">
              <ShieldCheck size={12} className="text-pink-400" /> Secure Documentation
            </div>
          </div>
            ...
            <div className="p-10 bg-white group">
              ...
              <div className="space-y-6">
                ...
                <div className="flex justify-between items-center py-2">
                  ...
                  <span className="text-lg font-bold text-slate-800">7,000 <span className="text-[10px] text-slate-400">QAR</span></span>
                </div>
                <div className="flex justify-between items-center py-2">
                  <span className="text-slate-500 text-sm font-medium">3rd Payment (Visa)</span>
                  <span className="text-lg font-bold text-slate-800">18,000 <span className="text-[10px] text-slate-400">QAR</span></span>
                </div>
                ...
                <div className="mt-8 p-6 bg-pink-50/30 rounded-2xl border-2 border-dashed border-pink-100">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-3xl font-black text-slate-800">28,000 <span className="text-sm font-bold text-pink-400">QAR</span></span>
                  </div>
                </div>
              </div>
            </div>

            {/* Bangladesh Payment Plan (1L-3L-6L) */}
            <div className="p-10 bg-white group">
              <div className="flex items-center gap-3 mb-10">
                <div className="p-2 bg-slate-50 rounded-xl group-hover:bg-pink-50 transition-colors">
              ...
              <div className="space-y-6">
                ...
                <div className="flex justify-between items-center py-2">
                  <span className="text-slate-500 text-sm font-medium">3rd Payment (Visa)</span>
                  <span className="text-lg font-bold text-slate-800">600,000 <span className="text-[10px] text-slate-400">BDT</span></span>
                </div>

                <div className="mt-8 p-6 bg-pink-50/30 rounded-2xl border-2 border-dashed border-pink-100">
                  <div className="flex justify-between items-center">
                    <span className="text-[10px] font-black text-pink-500 uppercase tracking-widest">Total Payable</span>
                    <span className="text-3xl font-black text-slate-800">1,000,000 <span className="text-sm font-bold text-pink-400">BDT</span></span>
                  </div>
                </div>
              </div>
            </div>
