      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        <header className="relative bg-linear-to-br from-[#fdf2f8] to-[#fce4ec] rounded-[2.5rem] shadow-sm border border-pink-100 p-10 text-center overflow-hidden">
          ...
          <h1 className="text-4xl sm:text-6xl font-light tracking-tight text-slate-800 italic">
            Bulgaria <span className="font-extrabold not-italic bg-clip-text text-transparent bg-linear-to-r from-pink-500 to-slate-800">Work Visa</span>
          </h1>
          <p className="mt-4 text-slate-500 text-lg font-medium tracking-wide">Skilled & General Labor Opportunities</p>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <aside className="space-y-6">
            <section className="bg-slate-700 text-white rounded-3xl shadow-lg p-8">
              ...
              <p className="text-3xl font-light italic text-white">700 – 900 €</p>
        ...
        <section className="bg-white rounded-[2.5rem] border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-slate-100">
            ...
            <div className="p-10 bg-white group">
              ...
              <div className="space-y-6">
                ...
                <div className="flex justify-between items-center py-2">
                  ...
                  <span className="text-lg font-bold text-slate-800">30,000 <span className="text-[10px] text-slate-400">QAR</span></span>
                </div>
            ...
            {/* Bangladesh Payment Plan (1L-3L-10L) */}
            <div className="p-10 bg-white group">
              <div className="flex items-center gap-3 mb-10">
                <div className="p-2 bg-slate-50 rounded-xl group-hover:bg-pink-50 transition-colors">
              ...
              <div className="space-y-6">
                ...
                <div className="flex justify-between items-center py-2">
                  <span className="text-slate-500 text-sm font-medium">3rd Payment (Visa)</span>
                  <span className="text-lg font-bold text-slate-800">1,000,000 <span className="text-[10px] text-slate-400">BDT</span></span>
                </div>

                <div className="mt-8 p-6 bg-pink-50/30 rounded-2xl border-2 border-dashed border-pink-100">
                  <div className="flex justify-between items-center">
                    <span className="text-[10px] font-black text-pink-500 uppercase tracking-widest">Total Payable</span>
                    <span className="text-3xl font-black text-slate-800">1,400,000 <span className="text-sm font-bold text-pink-400">BDT</span></span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <footer className="text-center py-8">
          ...
          <p className="text-slate-400 text-[10px] tracking-[0.4em] uppercase">© 2026 Bulgaria Recruitment Division</p>
        </footer>
      </div>
    </div>
  );
