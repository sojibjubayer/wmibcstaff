      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        <header className="relative bg-linear-to-br from-[#fdf2f8] to-[#fce4ec] rounded-[2.5rem] shadow-sm border border-pink-100 p-10 text-center overflow-hidden">
          ...
          <h1 className="text-4xl sm:text-6xl font-light tracking-tight text-slate-800 italic">
            New Zealand <span className="font-extrabold not-italic bg-clip-text text-transparent bg-linear-to-r from-pink-500 to-slate-800">Work Visa</span>
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <aside className="space-y-6">
            <section className="bg-slate-700 text-white rounded-3xl shadow-lg p-8">
              ...
              <p className="text-3xl font-light italic">32 NZD / Hour</p>
        ...
        <section className="bg-white rounded-[2.5rem] border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className="p-10">
            <div className="flex items-center gap-3 mb-10">
              ...
              <span className="font-bold text-slate-800 uppercase text-xs">Qatar Applicants</span>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-between items-center py-2">
                ...
                <span className="text-lg font-bold text-slate-800">40,000 <span className="text-[10px] text-slate-400">QAR</span></span>
              </div>
              ...
              <div className="mt-8 p-6 bg-pink-50/30 rounded-2xl border-2 border-dashed border-pink-100">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-3xl font-black text-slate-800">
                    45,000 <span className="text-sm font-bold text-pink-400">QAR</span>
                  </span>
                </div>
              </div>
            </div>
