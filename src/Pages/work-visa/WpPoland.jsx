    ...
    <div className="min-h-screen bg-[#f8fafc] py-12 px-4 sm:px-6 lg:px-8 text-slate-700 font-sans selection:bg-blue-100">
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {/* RIGHT SIDEBAR: SALARY */}
          <aside className="space-y-6">
            <section className="bg-slate-800 text-white rounded-3xl shadow-lg p-8 relative overflow-hidden flex flex-col justify-center h-full min-v-[180px]">
              ...
              <p className="text-4xl font-light italic text-blue-50">700 €</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="bg-white border border-slate-200/80 p-6 rounded-3xl shadow-xs flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-slate-400 text-xs italic mt-0.5">
                7 – 8 Months Total Processing Time
              </p>
            </div>
          </div>
