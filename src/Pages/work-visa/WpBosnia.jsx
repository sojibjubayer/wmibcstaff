...
const PAYMENTS = [
  ...
  { label: "3rd Payment (After Visa)", amount: "22,500" }, // Remaining amount
];
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] py-12 px-4 sm:px-6 lg:px-8 text-slate-700 font-sans">
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        {/* Header Section */}
        <header className="bg-linear-to-br from-[#fff3e0] to-[#ffe0b2] rounded-3xl shadow-sm border border-orange-100 p-10 text-center relative overflow-hidden">
          ...
          <h1 className="text-3xl sm:text-5xl font-bold tracking-tight text-slate-800">
            Bosnia <span className="font-light italic text-slate-700">Work Visa</span>
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <section className="md:col-span-2 bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {JOBS.map((job, index) => (
                <div
                  key={index}
                  className="flex items-center p-4 rounded-xl border border-slate-50 bg-[#fafafa] hover:bg-[#fff3e0]/20 transition-all duration-300"
                >
                  <span className="w-1.5 h-1.5 rounded-full bg-orange-300 mr-3"></span>
          ...
          <div className="space-y-6">
            <section className="bg-slate-700 text-white rounded-2xl shadow-lg p-7 text-center">
              <h3 className="text-orange-200 text-xs uppercase tracking-widest font-bold mb-2">Salary Package</h3>
              <p className="text-3xl font-light italic">27,000 QAR</p>
            ...
            <section className="bg-[#fff3e0]/20 border border-orange-100 rounded-2xl p-7 space-y-4">
              <div>
        ...
        <section className="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden">
          <div className="bg-slate-800 p-8 flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="bg-white/5 px-6 py-2 rounded-full border border-orange-300/30">
              <span className="text-2xl font-bold text-orange-200">27,000 <span className="text-sm font-normal text-slate-400 uppercase">QAR</span></span>
            </div>
          </div>
        ...
        <footer className="text-center text-slate-400 text-[10px] tracking-[0.3em] uppercase py-6">
          Bosnia Employment Division • Intake 2026
        </footer>
      </div>
    </div>
  );
