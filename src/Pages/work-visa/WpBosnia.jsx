      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        <header className="relative bg-linear-to-br from-[#fdf2f8] to-[#fce4ec] rounded-[2.5rem] shadow-sm border border-pink-100 p-10 text-center overflow-hidden">
          ...
          <h1 className="text-4xl sm:text-6xl font-light tracking-tight text-slate-800 italic">
            Bosnia <span className="font-extrabold not-italic bg-clip-text text-transparent bg-linear-to-r from-pink-500 to-slate-800">Work Visa</span>
          </h1>
          <p className="mt-4 text-slate-500 text-lg font-medium tracking-wide">General Worker Opportunities</p>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <section className="lg:col-span-2 bg-white rounded-3xl shadow-sm border border-slate-200 p-8">
            <h2 className="text-sm font-bold text-slate-400 uppercase tracking-[0.2em] mb-8 flex items-center gap-2">
              <Briefcase size={16} className="text-pink-400" /> Available Roles
            </h2>
            <div className="grid grid-cols-1 gap-3">
              {JOBS.map((job, index) => (
                <div key={index} className="group flex items-center p-6 rounded-xl border border-slate-50 bg-slate-50/50 hover:bg-white hover:border-pink-200 transition-all duration-300">
                  <div className="w-2 h-2 rounded-full bg-pink-400 mr-4"></div>
                  <span className="font-semibold text-slate-700 text-lg">{job}</span>
                </div>
              ))}
            </div>
          </section>
          ...
          <aside className="space-y-6">
            <section className="bg-slate-700 text-white rounded-3xl shadow-lg p-8">
              ...
              <p className="text-3xl font-light italic text-white">450 – 600 €</p>
        ...
        <section className="bg-white rounded-[2.5rem] border border-slate-200 shadow-sm overflow-hidden">
          <div className="bg-slate-50/50 px-10 py-8 border-b border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="px-4 py-1.5 bg-white rounded-full border border-slate-200 text-[10px] font-bold text-slate-500 uppercase flex items-center gap-2">
              <ShieldCheck size={12} className="text-pink-400" /> Verified Intake
            </div>
          </div>
            ...
            <div className="p-10 bg-white group">
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-center py-2">
                  ...
                  <span className="text-lg font-bold text-slate-800">1,500 <span className="text-[10px] text-slate-400">QAR</span></span>
                </div>
                <div className="flex justify-between items-center py-2">
                  <span className="text-slate-500 text-sm font-medium">2nd Payment (Permit)</span>
                  <span className="text-lg font-bold text-slate-800">3,000 <span className="text-[10px] text-slate-400">QAR</span></span>
                </div>
                <div className="flex justify-between items-center py-2">
                ...
                <div className="mt-8 p-6 bg-pink-50/30 rounded-2xl border-2 border-dashed border-pink-100">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-3xl font-black text-slate-800">27,000 <span className="text-sm font-bold text-pink-400">QAR</span></span>
                  </div>
                </div>
                <p className="font-semibold text-center italic text-pink-500 text-sm">Nepali / Indian / Srilankan: <span className="bg-gray-600 text-white px-2 rounded-md">12k(1.5+5+rest)</span> </p>
              </div>
            </div>

            {/* Bangladesh Payment Plan (1L-3L-7L) */}
            <div className="p-10 bg-white group">
              <div className="flex items-center gap-3 mb-10">
                <div className="p-2 bg-slate-50 rounded-xl group-hover:bg-pink-50 transition-colors">
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-center py-2">
                  <span className="text-slate-500 text-sm font-medium">1st Payment (Docs)</span>
                  <span className="text-lg font-bold text-slate-800">100,000 <span className="text-[10px] text-slate-400">BDT</span></span>
                </div>
                <div className="flex justify-between items-center py-2">
                  <span className="text-slate-500 text-sm font-medium">2nd Payment (Permit)</span>
                  <span className="text-lg font-bold text-slate-800">300,000 <span className="text-[10px] text-slate-400">BDT</span></span>
                </div>
                <div className="flex justify-between items-center py-2">
                  <span className="text-slate-500 text-sm font-medium">3rd Payment (Visa)</span>
                  <span className="text-lg font-bold text-slate-800">700,000 <span className="text-[10px] text-slate-400">BDT</span></span>
                </div>

                <div className="mt-8 p-6 bg-pink-50/30 rounded-2xl border-2 border-dashed border-pink-100">
                  <div className="flex justify-between items-center">
                    <span className="text-[10px] font-black text-pink-500 uppercase tracking-widest">Total Payable</span>
                    <span className="text-3xl font-black text-slate-800">1,100,000 <span className="text-sm font-bold text-pink-400">BDT</span></span>
                  </div>
                </div>
              </div>
            </div>
