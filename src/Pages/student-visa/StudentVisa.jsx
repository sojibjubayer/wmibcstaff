...
import { Search, Globe, Banknote, ListChecks, ArrowUpRight, GraduationCap, MapPin } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-black tracking-tight text-slate-900 uppercase">Study Visa 2026</h1>
              <p className="text-slate-400 text-[10px] font-black uppercase tracking-[0.2em]">Global Admission Database</p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-xl shadow-slate-200/40">
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="text-[10px] font-black bg-pink-100 text-pink-600 px-3 py-1 rounded-full">{progress}%</span>
              </div>
                ...
                {checklistItems.map((doc, i) => (
                  ...
                  >
                    ...
                    <span className={`text-[11px] font-bold transition-colors ${
                      checkedDocs.includes(doc) ? "text-slate-400" : "text-slate-700"
                    }`}>
                      {doc}
                    </span>
                  </label>
