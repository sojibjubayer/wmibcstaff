...
const VisitSwitzerland = () => {
  return (
    <div className="min-h-screen bg-gray-50 pt-1 px-4 sm:px-6 md:px-10 pb-6">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">

        {/* Gradient Header */}
        <div className="bg-linear-to-r from-red-700 via-white to-red-700 px-6 py-6">
          <h1 className="text-3xl sm:text-4xl font-bold text-center text-gray-900">
            Switzerland – Schengen Visitor Visa
          </h1>
        </div>
        ...
        <div className="p-6 sm:p-8">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Each applicant applies separately; family members may apply together.
            </p>
          </div>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-1">
              <li>
                ...
                >
                  Switzerland Visa – Official Info
                </a>
              </li>
              <li>
                <a
                  href="https://visa.vfsglobal.com/qat/en/che/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-green-700 hover:underline"
                >
                  VFS Global – Switzerland Visa in Qatar
                </a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-1">
              ...
              <li>Travel medical insurance (€30,000 minimum)</li>
              <li>Employment or sponsor letter</li>
              <li>Ties to home (job, family, assets)</li>
            </ul>
          </div>
        </div>
      </div>
...
export default VisitSwitzerland;
