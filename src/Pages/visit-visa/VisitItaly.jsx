  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-1 px-4 sm:px-6 md:px-10 pb-6">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        {/* Gradient Header */}
        <div className="bg-linear-to-r from-green-600 via-white to-red-600 px-6 py-6">
          <h1 className="text-3xl sm:text-4xl font-bold text-center text-gray-900">
            Italy – Schengen Visitor Visa
          </h1>
        </div>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-1">
              <li>
                ...
                >
                  Italy Visa – Official Portal
                </a>
              </li>
              <li>
                <a
                  href="https://visa.vfsglobal.com/qat/en/ita/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-green-700 hover:underline"
                >
                  VFS Global – Italy Visa in Qatar
                </a>
              </li>
            </ul>
          </div>
