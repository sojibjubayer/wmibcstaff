  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-1 px-4 sm:px-6 md:px-10 pb-6">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        {/* Gradient Header */}
        <div className="bg-linear-to-r from-red-700 via-yellow-400 to-red-700 px-6 py-6">
          <h1 className="text-3xl sm:text-4xl font-bold text-center text-gray-900">
            Spain – Schengen Visitor Visa
          </h1>
        </div>
        ...
        <div className="p-6 sm:p-8">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              ~330–400 QAR (Embassy visa fee) + ~100–150 QAR (VFS / BLS service fee)
            </p> 
          </div>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-1">
              <li>
                ...
                >
                  Spain Visa – Official Information
                </a>
              </li>
              <li>
                <a
                  href="https://qatar.blsspainvisa.com/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-green-700 hover:underline"
                >
                  BLS International – Spain Visa in Qatar
                </a>
              </li> 
            </ul>
          </div>
