      ...
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="p-6 sm:p-8">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Individual application required; family may apply together.
            </p>
          </div>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-1">
              <li>
                ...
                >
                  Austria Visa – Official Info
                </a>
              </li>
              <li>
                <a
                  href="https://visa.vfsglobal.com/qat/en/aut/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-green-700 hover:underline"
                >
                  VFS Global – Austria Visa in Qatar
                </a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-1">
              ...
              <li>Flight & accommodation proof</li>
