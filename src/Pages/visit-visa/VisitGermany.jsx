  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-1 px-4 sm:px-6 md:px-10 pb-6">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        {/* Gradient Header */}
        <div className="bg-linear-to-r from-black via-red-600 to-yellow-400 px-6 py-6">
          <h1 className="text-3xl sm:text-4xl font-bold text-center text-gray-200">
            Germany – Schengen Visitor Visa
          </h1>
        </div>
        ...
        <div className="p-6 sm:p-8">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600">
             €90 (~365 QAR) for adults; €45 (~183 QAR) for children 6–12 + 110–130 QAR (VFS Service Fee)
            </p>
          </div> 
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-1">
              <li>
                <a
                  href="https://www.germany.info/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-green-700 hover:underline"
                >
                  German Missions – Visa Information
                </a>
              </li>
              <li>
                <a
                  href="https://visa.vfsglobal.com/qat/en/deu/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-green-700 hover:underline"
                >
                  VFS Global – Germany Visa in Qatar
                </a>
              </li>
            </ul>
          </div>
