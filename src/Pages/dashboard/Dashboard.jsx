  ...
  return (
    <div className="flex h-screen bg-slate-50 font-sans text-slate-900 overflow-hidden">
      ...
      <main className="flex-1 flex flex-col min-w-0">
        <DashboardHeader fetchData={loadData} loading={loading} />
...
//       clients.forEach((c) => {
//         const payments = Array.isArray(c.amountReceived)
//           ? c.amountReceived
//           : [c.amountReceived];
//         payments.forEach((p) => {
...
//       // Sort data
//       setAllVisitors(
//         visitors.sort((a, b) => new Date(b.date) - new Date(a.date)),
//       );
//       setAllClients(
...
//             </div>
//           )}
//       {visitorModalOpen && selectedVisitor && (
...
//       {/* Modal Body */}
//       <div className="p-5 bg-slate-50 space-y-2 text-sm">
//         <p><strong>Name:</strong> {selectedVisitor.name}</p>
//         <p><strong>Mobile:</strong> {selectedVisitor.mobile}</p>
//         <p><strong>Age:</strong> {selectedVisitor.age}</p>
//         <p><strong>Address:</strong> {selectedVisitor.currentAddress}</p>
//         <p><strong>Profession:</strong> {selectedVisitor.profession}</p>
//         <p><strong>Visa Type:</strong> {selectedVisitor.visaType}</p>
//         <p><strong>Nationality:</strong> {selectedVisitor.nationality}</p>
//         <p><strong>Interested Country:</strong> {selectedVisitor.interestedCountry}</p>
//         <p><strong>Payment Terms:</strong> {selectedVisitor.paymentTerms}</p>
//         <p><strong>Consultation Status:</strong> {selectedVisitor.consultationStatus}</p>
//         {selectedVisitor.visitorComment && (
//           <p><strong>Visitor Comment:</strong> {selectedVisitor.visitorComment}</p>
//         )}
//       </div>
